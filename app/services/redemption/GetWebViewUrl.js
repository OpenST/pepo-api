...
/**
 * Class to get redemption web view url.
 *
 * @class GetWebViewUrl
 */
class GetWebViewUrl extends ServiceBase {
  /**
   * Constructor to get redemption web view url.
   *
   * @param {object} params
  ...
  async _asyncPerform() {
    ...
    const link = `${webPageConstants.redemptionWebViewProductLink}?rt=${urlToken}`;
    ...
    if (secureUserObj.status !== userConstants.activeStatus) {
      return Promise.reject(
        responseHelper.paramValidationError({
          internal_error_identifier: 'a_s_r_gwvu_1',
