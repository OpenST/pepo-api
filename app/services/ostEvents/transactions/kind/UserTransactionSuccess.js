 ...
 *
 * @class UserTransactionSuccessTransactionKind
 */
class UserTransactionSuccessTransactionKind extends TransactionKindBase {
  /**
   * Async perform.
   *
...
module.exports = UserTransactionSuccessTransactionKind;
