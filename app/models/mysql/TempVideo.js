...
class Video extends ModelBase {
  ...
  async updateVideo(params) {
    ...
    console.log('====params.resolutions====', params.resolutions);
  ...
  _formatResolutionsToInsert(resolutions) {
    ...
    for (const resolution in resolutions) {
      console.log('====resolution===111111=', resolution);
      if (resolution === 'o') {
        responseResolutionHash.o = oThis._formatResolutionToInsert(resolutions[resolution].o);
        responseResolutionHash.o.u = resolutions[resolution].o.u;
      } else {
  ...
  _formatResolutionToInsert(resolution) {
    ...
    console.log('====resolution==2222222==', resolution);
