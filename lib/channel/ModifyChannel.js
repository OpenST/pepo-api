...
class ModifyChannel {
  ...
  async _associateAdminsToChannel() {
    ...
    const channelAdminIds = await new ChannelUserModel().fetchAdminProfilesByChannelIds([oThis.channelId]);
    ...
    console.log('=existingAdminsMap====', adminUserIdsToAssociate);
    ...
    console.log('=existingAdminsMap====', adminUserIdsToDisassociate);
