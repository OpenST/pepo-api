...
class ModifyChannel {
  ...
  async _associateAdminsToChannel() {
    ...
    console.log('==channelAdminIdMap==', channelAdminIdMap);
    console.log('==channelAdminIds==', channelAdminIds);
    const existingAdminsMap = {};
    for (let index = 0; index < channelAdminIds.length; index++) {
      existingAdminsMap[channelAdminIds[index]] = 1;
    }

    console.log('=existingAdminsMap====', existingAdminsMap);
    ...
    console.log('=newAdminsMap====', newAdminsMap);
    ...
    console.log('=adminUserIdsToAssociate====', adminUserIdsToAssociate);
    ...
    console.log('=adminUserIdsToDisassociate====', adminUserIdsToDisassociate);
