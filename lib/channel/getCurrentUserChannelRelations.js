...
class GetCurrentUserChannelRelations {
  ...
  async _fetchUserChannelRelations() {
    ...
    // TODO:channels - oThis.currentUserChannelRelations will be empty if no entry found in channel_users table. We should loop on oThis.channelIds instead of cache response.
