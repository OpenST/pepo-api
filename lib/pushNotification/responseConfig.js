...
module.exports = {
  ...
  [notificationHookConstant.replyOnYourVideoWithAmountKind]: {
    headings: {
      '1': {
  ...
  [notificationHookConstant.replyOnYourVideoWithoutAmountKind]: {
    headings: {
      '1': {
        body: `{{${headingVarConstant.actorName}}} replied to your video.`,
        templateVars: [headingVarConstant.actorName]
  ...
  [notificationHookConstant.videoAddInChannelKind]: {
    headings: {
      '1': {
        body: `There is a new video in {{${headingVarConstant.channelName}}}.`,
