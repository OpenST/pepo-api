...
class MsgFormatter {
  ...
  async perform() {
    ...
    promisesArray.push(oThis._getHeading());
  ...
  async _setUserAndAmount() {
    ...
    oThis.amount = oThis._getAmountForNotification(supportingEntitiesConfig);
  ...
  _getAmountForNotification(supportingEntitiesConfig) {
    ...
    amount = basicHelper.convertWeiToNormal(amount);
  ...
  _prepareResponse() {
    ...
    formattedPushNotification.data = {
    ...
    return formattedPushNotification;
  }
