const rootPrefix = '../../../..',
  ...
  ProductSingleFormatter = require(rootPrefix + '/lib/formatter/strategy/products/Single'),
  responseHelper = require(rootPrefix + '/lib/formatter/response');

/**
 * Class for product list formatter.
 *
 * @class ProductListFormatter
 */
class ProductListFormatter extends BaseFormatter {
  /**
  ...
  constructor(params) {
    ...
    oThis.products = params.products;
  }
  ...
  _format() {
    ...
    for (let index = 0; index < oThis.products.length; index++) {
      ...
      const formattedProduct = new ProductSingleFormatter({ product: product }).perform();
...
module.exports = ProductListFormatter;
