...
class ChannelsMapFormatter extends BaseFormatter {
  /**
   * Constructor for channels map formatter.
   *
   * @param {object} params
  ...
  _validate() {
    ...
    if (!CommonValidators.validateObject(oThis.channelsMap)) {
      return responseHelper.error({
        internal_error_identifier: 'l_f_s_c_m_1',
...
module.exports = ChannelsMapFormatter;
