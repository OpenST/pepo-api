...
class twitterUserMapFormatter extends BaseFormatter {
  ...
  constructor(params) {
    ...
    oThis.secureTwitterUsersMap = params.secureTwitterUsersMap;
  }
  ...
  _validate() {
    ...
    if (!CommonValidators.validateObject(oThis.secureTwitterUsersMap)) {
  ...
  _format() {
    ...
    for (const userId in oThis.secureTwitterUsersMap) {
      const twitterUserObj = oThis.secureTwitterUsersMap[userId],
