...
class ReplyDetailSingleFormatter extends BaseFormatter {
   ...
   * @param {string} params.videoDetail.totalAmountRaisedInWie
  ...
  _validate() {
    ...
    const replyDetailKeyConfig = {
      ...
      totalAmountRaisedInWie: { isNullAllowed: false },
  ...
  _format() {
    ...
    return responseHelper.successWithData({
      ...
      total_contributed_by: oThis.replyDetail.totalContributedBy,
      total_amount_raised_in_wei: oThis.replyDetail.totalAmountRaisedInWie,
      total_transactions: oThis.replyDetail.totalTransactions,
      parent_id: Number(oThis.replyDetail.parentId),
      parent_kind: Number(oThis.replyDetail.parentKind),
      uts: Number(oThis.replyDetail.updatedAt)
    });
  }
}
