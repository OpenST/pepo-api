...
class currentUserReplyDetailContributionsMapFormatter extends BaseFormatter {
  ...
  _format() {
    ...
    for (const replyDetailId in oThis.currentUserReplyDetailContributionsMap) {
      const currentUserReplyDetailContribution = oThis.currentUserReplyDetailContributionsMap[replyDetailId],
      ...
      finalResponse[replyDetailId] = formattedCurrentUserReplyDetailContributionRsp.data.totalAmount;
    }
