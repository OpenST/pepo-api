const rootPrefix = '../../../..',
  ...
  CurrentUserReplyChannelRelationsSingleFormatter = require(rootPrefix +
    '/lib/formatter/strategy/currentUserChannelRelations/Single'),
  responseHelper = require(rootPrefix + '/lib/formatter/response');

/**
 * Class for current user channel relations map formatter.
 *
 * @class CurrentUserChannelRelationsMapFormatter
 */
class CurrentUserChannelRelationsMapFormatter extends BaseFormatter {
  /**
...
module.exports = CurrentUserChannelRelationsMapFormatter;
