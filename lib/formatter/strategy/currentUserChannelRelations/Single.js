...
/**
 * Class for current user channel relations formatter.
 *
 * @class CurrentUserChannelRelationsSingleFormatter
 */
class CurrentUserChannelRelationsSingleFormatter extends BaseFormatter {
  /**
   * Constructor for current user channel relations formatter.
   *
   * @param {object} params
  ...
  _format() {
    ...
    return responseHelper.successWithData({
      ...
      is_admin: oThis.currentUserChannelRelation.isAdmin,
      is_member: oThis.currentUserChannelRelation.isMember,
      notification_status: oThis.currentUserChannelRelation.notificationStatus,
      uts: oThis.currentUserChannelRelation.updatedAt
    });
  }
}

module.exports = CurrentUserChannelRelationsSingleFormatter;
