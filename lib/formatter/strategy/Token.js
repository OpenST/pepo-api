...
class Token extends BaseFormatter {
   ...
   * @param {number} params.tokenDetails.auxChainId
  ...
  _format() {
    ...
    return responseHelper.successWithData({
      ...
      aux_chain_id: Number(oThis.tokenDetails.auxChainId),
      ...
      utility_branded_token: oThis.tokenDetails.utilityBrandedToken,
