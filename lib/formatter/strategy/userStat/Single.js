...
class UserStatSingleFormatter extends BaseFormatter {
  ...
  _validate() {
    ...
    const userStatKeyConfig = {
      ...
      totalAmountSpent: { isNullAllowed: false },
      referralCount: { isNullAllowed: true },
      createdAt: { isNullAllowed: false },
      updatedAt: { isNullAllowed: false }
    };

    return oThis.validateParameters(oThis.userStat, userStatKeyConfig);
  }
  ...
  _format() {
    ...
    return responseHelper.successWithData({
      ...
      total_amount_spent_in_wei: oThis.userStat.totalAmountSpent,
      referral_count: oThis.userStat.referralCount,
      uts: oThis.userStat.updatedAt
    });
  }
}
