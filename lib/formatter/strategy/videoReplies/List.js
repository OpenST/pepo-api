const rootPrefix = '../../../..',
  ...
  VideoReplySingleFormatter = require(rootPrefix + '/lib/formatter/strategy/videoReplies/Single'),
 ...
 *
 * @class VideoReplyListFormatter
 */
class VideoReplyListFormatter extends BaseFormatter {
  /**
  ...
  constructor(params) {
    ...
    oThis.videoReplyList = params[entityType.videoReplyList];
  }
  ...
  _validate() {
    ...
    if (!CommonValidators.validateArray(oThis.videoReplyList)) {
      return responseHelper.error({
        internal_error_identifier: 'l_f_s_vr_l_1',
...
module.exports = VideoReplyListFormatter;
