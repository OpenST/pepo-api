...
class ChannelAllowedActionSingleFormatter extends BaseFormatter {
   ...
   * @param {number} params.channelAllowedAction.isAdmin
   * @param {number} params.channelAllowedAction.isMember
   * @param {number} params.channelAllowedAction.notificationStatus
