...
class ActivitySingleFormatter extends BaseFormatter {
  ...
  _validate() {
    ...
    const activityValidationResponse = oThis._validateParameters(oThis.activity, activityKeyConfig);
    ...
    return oThis._validateParameters(oThis.activity.payload, activityPayloadKeyConfig);
  }
  ...
  _format() {
    ...
    return responseHelper.successWithData({
      ...
      updated_at: oThis.activity.updatedAt,
      payload: {
        text: payload.text || '',
