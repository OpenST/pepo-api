...
class ChannelStatSingleFormatter extends BaseFormatter {
  ...
  _format() {
    ...
    return responseHelper.successWithData({
      ...
      total_users: Number(oThis.channelStat.totalUsers) < 0 ? 0 : Number(oThis.channelStat.totalUsers),
      total_videos: Number(oThis.channelStat.totalVideos) < 0 ? 0 : Number(oThis.channelStat.totalVideos),
