...
class VideoDetailSingleFormatter extends BaseFormatter {
  ...
  _validate() {
    ...
    return oThis._validateParameters(oThis.videoDetail, videoDetailKeyConfig);
  }
  ...
  _format() {
    ...
    return responseHelper.successWithData({
      ...
      creator_user_id: oThis.videoDetail.creatorUserId,
      video_id: oThis.videoDetail.videoId,
      total_contributed_by: oThis.videoDetail.totalContributedBy,
      total_amount: oThis.videoDetail.totalAmount,
      total_transactions: oThis.videoDetail.totalTransactions,
      created_at: Number(oThis.videoDetail.createdAt),
      updated_at: Number(oThis.videoDetail.updatedAt)
    });
  }
}
