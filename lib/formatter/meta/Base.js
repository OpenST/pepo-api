...
class BaseMetaFormatter {
  ...
  _constructMeta() {
    ...
    if (oThis._isPaginationIdentifierPresent()) {
      let paginationIdentifier = oThis.meta[pagination.nextPagePayloadKey][pagination.paginationIdentifierKey];
      meta[pagination.nextPagePayloadKey][pagination.paginationIdentifierKey] = basicHelper.encryptPageIdentifier(
        paginationIdentifier
      );
    } else {
      meta[pagination.nextPagePayloadKey] = null;
    }
  ...
  _isPaginationIdentifierPresent() {
    ...
    if (oThis.paginationIdentifierPresent == null) {
      let nextPagePayload = oThis.meta[pagination.nextPagePayloadKey] || {};
