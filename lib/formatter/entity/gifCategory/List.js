const rootPrefix = '../../../..',
  ...
  GifCategorySingleFormatter = require(rootPrefix + '/lib/formatter/entity/gifCategory/Single'),
...
class GifCategoryListFormatter extends BaseFormatter {
  ...
  _validate() {
    ...
    if (CommonValidator.validateArray(oThis.gifCategories)) {
  ...
  _format() {
    ...
    for (let index = 0; index < oThis.gifCategories.length; index++) {
      ...
      finalResponse.push(formattedGifCategory);
    }
