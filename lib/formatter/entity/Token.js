...
class Token extends BaseFormatter {
  ...
  _validate() {
    ...
    return oThis._validateParameters(oThis.tokenDetails, tokenDetailsKeyConfig);
  }
  ...
  _format() {
    ...
    return responseHelper.successWithData({
      ...
      decimal: oThis.tokenDetails.decimal,
      ost_token_id: oThis.tokenDetails.ostTokenId,
      ...
      updated_at: Number(oThis.tokenDetails.updatedAt)
    });
  }
}
