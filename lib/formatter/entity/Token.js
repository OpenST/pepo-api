...
class Token {
   ...
   * @param {String} params.tokenDetails.apiKey
   * @param {String} params.tokenDetails.apiSecret
   * @param {String} params.tokenDetails.encryptionSalt
  ...
  perform() {
    ...
    const formattedData = {
      ...
      api_key: oThis.params.tokenDetails.apiKey,
      api_secret: oThis.params.tokenDetails.apiSecret,
      encryption_salt: oThis.params.tokenDetails.encryptionSalt,
