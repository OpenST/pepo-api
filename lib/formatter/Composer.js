...
class FormatterComposer {
  ...
  constructor(params) {
    ...
    oThis.entityClassMapping = {
      ...
      [entityType.channelList]: ChannelListFormatter,
      [entityType.channelsMap]: ChannelMapFormatter,
      ...
      [entityType.channelListMeta]: ChannelMapMetaFormatter,
      [entityType.userVideoListMeta]: UserVideoListMetaFormatter,
      [entityType.tagVideoListMeta]: TagVideoListMetaFormatter,
      [entityType.channelVideosListMeta]: ChannelVideosListMetaFormatter,
      ...
      [entityType.currentUserReplyDetailContributionsMap]: CurrentUserReplyDetailContributionsMapFormatter,
      [entityType.currentUserVideoRelationsMap]: CurrentUserVideoRelationsMapFormatter,
      [entityType.currentUserReplyDetailsRelationsMap]: CurrentUserReplyDetailRelationsMapFormatter,
      [entityType.pricePointsMap]: PricePointsMapFormatter,
      [entityType.loggedInUser]: LoggedInUserSingleFormatter,
      [entityType.utmParams]: UtmParamsSingleFormatter,
      [entityType.channel]: ChannelSingleFormatter,
      [entityType.channelDetailsMap]: ChannelDetailMapFormatter,
      [entityType.channelStatsMap]: ChannelStatMapFormatter,
      [entityType.currentUserChannelRelationsMap]: CurrentUserChannelRelationMapFormatter,
      ...
      [entityType.userReplyList]: UserRepliesListFormatter,
      [entityType.tagVideoList]: UserVideosListFormatter,
      [entityType.channelVideoList]: ChannelVideosListFormatter,
      [entityType.channelUserList]: UserMapFormatter,
      [entityType.textsMap]: TextMapFormatter,
      ...
      [entityType.videoMergeJob]: VideoMergeJobFormatter,
      [entityType.pepocornBalance]: PepocornBalanceSingleFormatter,
      [entityType.pepocornTopupInfo]: PepocornTopUpSingleFormatter,
      [entityType.twitterConnectMeta]: TwitterConnectMetaSingleFormatter,
      [entityType.unseenReplies]: UnseenRepliesListFormatter
    };
