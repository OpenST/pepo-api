const rootPrefix = '../..',
  ...
  LimitsDataFormatter = require(rootPrefix + '/lib/formatter/strategy/LimitsData'),
  ProductListFormatter = require(rootPrefix + '/lib/formatter/strategy/products/List'),
...
class FormatterComposer {
  ...
  constructor(params) {
    ...
    oThis.entityClassMapping = {
      ...
      [entityType.products]: ProductListFormatter,
      [entityType.paymentReceipt]: PaymentReceiptFormatter,
      [entityType.limitsData]: LimitsDataFormatter
    };
