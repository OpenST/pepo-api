const rootPrefix = '../..',
  ...
  AdminTwitterUserMapFormatter = require(rootPrefix + '/lib/formatter/strategy/adminTwitterUser/Map'),
...
class FormatterComposer {
  ...
  constructor(params) {
    ...
    oThis.entityClassMapping = {
      ...
      [entityType.adminTwitterUsersMap]: AdminTwitterUserMapFormatter,
