const rootPrefix = '../..',
  ...
  CurrentUserChannelRelationsMapFormatter = require(rootPrefix +
    '/lib/formatter/strategy/currentUserChannelRelations/Map'),
...
class FormatterComposer {
  ...
  constructor(params) {
    ...
    oThis.entityClassMapping = {
      ...
      [entityType.currentUserChannelRelationsMap]: CurrentUserChannelRelationsMapFormatter,
      ...
      [entityType.channelVideoList]: UserVideosListFormatter,
