const rootPrefix = '../..',
  ...
  JoinZoomMeetingPayloadFormatter = require(rootPrefix + '/lib/formatter/strategy/joinZoomMeetingPayload/Single'),
  MeetingFormatter = require(rootPrefix + '/lib/formatter/strategy/meeting/Single'),
  ...
  PepoTwitterDetailsSingleFormatter = require(rootPrefix + '/lib/formatter/strategy/pepoTwitterDetails/Single'),
...
const entityClassMapping = {
  ...
  [entityTypeConstants.joinZoomMeetingPayload]: JoinZoomMeetingPayloadFormatter,
  ...
  [entityTypeConstants.pepoTwitterDetails]: PepoTwitterDetailsSingleFormatter,
  ...
  [entityTypeConstants.meeting]: MeetingFormatter,
