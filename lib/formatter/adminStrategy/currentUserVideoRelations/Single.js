 ...
 *
 * @class AdminCurrentUserVideoRelationsSingleFormatter
 */
class AdminCurrentUserVideoRelationsSingleFormatter extends BaseFormatter {
  /**
...
module.exports = AdminCurrentUserVideoRelationsSingleFormatter;
