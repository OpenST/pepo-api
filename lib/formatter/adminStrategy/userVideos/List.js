const rootPrefix = '../../../..',
  ...
  UserVideoSingleFormatter = require(rootPrefix + '/lib/formatter/adminStrategy/userVideos/Single'),
...
class UserVideoListFormatter extends BaseFormatter {
  ...
  constructor(params) {
    ...
    oThis.userVideoList = params[adminEntityType.userVideoList];
  }
  ...
  _validate() {
    ...
    if (!CommonValidators.validateArray(oThis.userVideoList)) {
      return responseHelper.error({
        internal_error_identifier: 'l_f_as_uv_l_1',
