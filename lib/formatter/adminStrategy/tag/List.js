const rootPrefix = '../../../..',
  ...
  TagSingleFormatter = require(rootPrefix + '/lib/formatter/adminStrategy/tag/Single'),
  ...
  _validate() {
    ...
    if (!CommonValidators.validateArray(oThis.tagIds)) {
      return responseHelper.error({
        internal_error_identifier: 'l_f_as_t_l_1',
    ...
    if (!CommonValidators.validateObject(oThis.tagsMap)) {
      return responseHelper.error({
        internal_error_identifier: 'l_f_as_t_l_2',
        api_error_identifier: 'entity_formatting_failed',
