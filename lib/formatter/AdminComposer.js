const rootPrefix = '../..',
  ...
  CurrentUserVideoRelationsMapFormatter = require(rootPrefix +
    '/lib/formatter/adminStrategy/currentUserVideoRelations/Map'),
...
class AdminFormatterComposer {
  ...
  constructor(params) {
    ...
    oThis.entityClassMapping = {
      ...
      [adminEntityType.currentUserVideoRelationsMap]: CurrentUserVideoRelationsMapFormatter
    };
