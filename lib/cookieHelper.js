...
class CookieHelper {
  ...
  deleteWebLoginCookie(responseObject) {
    responseObject.clearCookie(userConstants.webLoginCookieName, { domain: coreConstants.PA_COOKIE_DOMAIN });
  }
  ...
  deleteWebviewLoginCookie(responseObject) {
    responseObject.clearCookie(userConstants.loginFromWebviewCookieName, { domain: coreConstants.PA_COOKIE_DOMAIN });
  }
  ...
  deleteStoreLoginCookie(responseObject) {
    responseObject.clearCookie(userConstants.loginStoreCookieName, { domain: coreConstants.PA_COOKIE_DOMAIN });
  }
