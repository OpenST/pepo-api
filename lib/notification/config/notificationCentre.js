...
module.exports = {
  ...
  [userNotificationConstants.airdropDoneKind]: {
    headings: {
      '1': {
        title: `Let's get started. We've airdropped {{${headingVarConstant.payloadAmount}}} pepo coins in your wallet.`,
  ...
  [userNotificationConstants.topupDoneKind]: {
    headings: {
      '1': {
        title: `Your Top-up transaction of {{${headingVarConstant.payloadAmount}}} pepo coins is complete.`,
        templateVars: [headingVarConstant.payloadAmount]
      }
    },
    image: imageVarConstant.subjectImage,
