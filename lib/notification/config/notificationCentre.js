...
module.exports = {
  ...
  [userNotificationConstants.profileTxReceiveSuccessKind]: {
    headings: {
      '1': {
        title: `{{${headingVarConstant.actorName}}} supported you with`,
    ...
    goto: {
      kind: gotoConstants.contributedByGotoKind,
      params: { userId: ['subjectUserId'] }
    }
  },
  ...
  [userNotificationConstants.airdropDoneKind]: {
    headings: {
      '1': {
        title: `Welcome to Pepo! You just received {{${headingVarConstant.payloadAmount}}} free Pepo Coins.`,
  ...
  [userNotificationConstants.topupDoneKind]: {
    headings: {
      '1': {
        title: `Your account is recharged with {{${headingVarConstant.payloadAmount}}}`,
        templateVars: [headingVarConstant.payloadAmount]
      }
    },
    image: imageVarConstant.subjectImage,
  ...
  [userNotificationConstants.videoAddKind]: {
    headings: {
      '1': {
        title: `{{${headingVarConstant.actorNamePossessive}}} added a new video.`,
  ...
  [userNotificationConstants.recoveryInitiateKind]: {
    headings: {
      '1': {
        title: `Looks like there is a wallet recovery attempt from a new device. If this wasn't you, contact us on support@pepo.com to abort this recovery attempt.`,
        templateVars: []
      }
    },
    image: null,
