...
module.exports = {
  ...
  [userNotificationConstants.replyUserMentionKind]: {
    headings: {
      '1': {
        body: `{{${headingVarConstant.actorName}}} mentioned you in a reply.`,
        templateVars: [headingVarConstant.actorName]
      }
    },
    image: imageVarConstant.actorImage,
  ...
  [userNotificationConstants.replySenderWithAmountKind]: {
    headings: {
      '1': {
        ...
        templateVars: [headingVarConstant.subjectNamePossessive, headingVarConstant.payloadAmount]
      }
    },
    image: imageVarConstant.actorImage,
    payload: {
  ...
  [userNotificationConstants.replyReceiverWithAmountKind]: {
    headings: {
      '1': {
        body: `{{${headingVarConstant.actorName}}} replied to your video. {{${headingVarConstant.payloadAmount}}}`,
