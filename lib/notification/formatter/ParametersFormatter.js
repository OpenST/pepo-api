...
class ParametersFormatter {
  ...
  static getInsertionParametersForKind(insertionParameters) {
    ...
    console.log('notificationKind=======', notificationKind);
    ...
    console.log('sanitizedParameters=======', sanitizedParameters);
    ...
    console.log('replacedInsertionParameters=======', replacedInsertionParameters);
