...
class ParametersFormatter {
   ...
   * @returns {result}
   */
  static getInsertionParametersForKind(kind, insertionParameters) {
    const validationResponse = ParametersFormatter.validateKindSpecificParameters(kind, insertionParameters);
