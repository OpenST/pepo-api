...
class NotificationHelper {
  ...
  static headingNotificationConfigForKind(kind, headingVersion, notificationType) {
    let config = NotificationHelper.getConfigForKindAndNotificationType(kind, notificationType);

    let headingConfig = config.headings[headingVersion] || config.headings[1];
