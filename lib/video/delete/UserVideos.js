...
class UserVideos extends VideoDeleteBase {
  ...
  async _deleteReplyVideos(videoIds) {
    ...
    //todo-replies: No index on and parent kind parent id. Where clause on parent kind missing and reply entity kind
    //what if already deleted reply
    ...
    if (replyDetailsIds.length > 0) {
      ...
      //todo-replies: why flush cache here?
