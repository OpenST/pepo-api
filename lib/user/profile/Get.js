...
class GetUserProfile {
  ...
  async perform() {
    ...
    if (oThis.currentUserId == 2127) {
      console.log(
        '--TRIALLLLLLL-----11----------------------------oThis.pricePoints-----',
        JSON.stringify(oThis.pricePoints)
      );
    }
    ...
    if (oThis.currentUserId == 2127) {
      console.log(
        '--TRIALLLLLLL-----22----------------------------oThis.pricePoints-----',
        JSON.stringify(oThis.pricePoints)
      );
    }
  ...
  async _fetchPricePoints() {
    ...
    if (oThis.currentUserId == 2127) {
      console.log(
        '--TRIALLLLLLL-------------------------------------------pricePointsCacheRsp--',
        JSON.stringify(pricePointsCacheRsp)
      );
    }
