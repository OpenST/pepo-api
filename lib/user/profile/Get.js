const rootPrefix = '../../..',
  ...
  VideoDetailsByVideoIdsAndUserIdCache = require(rootPrefix +
...
class GetUserProfile {
  ...
  async perform() {
    ...
    await oThis._fetchUserContributions();
  ...
  async _fetchVideoDetails() {
    ...
    const videoDetailsByVideoIdsAndUserIdCacheObj = new VideoDetailsByVideoIdsAndUserIdCache({
        videoIds: oThis.videoIdsArray,
        userId: oThis.userId
      }),
      cacheRsp = await videoDetailsByVideoIdsAndUserIdCacheObj.fetch();
  ...
  async _fetchUserContributions() {
    ...
    console.log(
      'videoDetailsByVideoIdsAndUserIdCacheRsp======',
      userContributorByUserIdsAndContributedByUserIdCacheRsp
    );
