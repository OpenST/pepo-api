...
class GetUserProfile {
  ...
  async _fetchProfileElements() {
    ...
    let posterImageId = profileInfo[userProfileElementConst.coverVideoKind].posterImageId;
    let posterImageData = await oThis._fetchImage(posterImageId);

    profileInfo['posterImage'] = posterImageData;
  }
