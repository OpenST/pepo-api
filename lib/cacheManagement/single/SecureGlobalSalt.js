...
class SecureGlobalSalt extends CacheSingleBase {
   ...
   *
   * @param {object} params
   * @param {string/number} params.globalSaltId
   *
   * @sets oThis.globalSaltId
   *
   * @private
   */
  _initParams(params) {
    ...
    oThis.globalSaltId = params.globalSaltId;
  }
  ...
  setCacheKey() {
    ...
    oThis.cacheKey = `${oThis._cacheKeyPrefix()}_config_strategy_salt_${oThis.globalSaltId}`;
  ...
  async fetchDataFromSource() {
    ...
    const addressSalt = await globalSaltModelObj.getById(oThis.globalSaltId);
