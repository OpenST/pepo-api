 ...
 *
 * @class VideoDetailsByUserIdPagination
 */
class VideoDetailsByUserIdPagination extends CacheSingleBase {
  /**
  ...
  setPaginatedBaseCacheKey() {
    ...
    oThis.baseCacheKey = oThis._cacheKeyPrefix() + `_vd_uid_${oThis.userId}`;
  }
  ...
  async fetchDataFromSource() {
    ...
    const fetchUsersRsp = await new VideoDetailModel().fetchByCreatorUserId({
...
module.exports = VideoDetailsByUserIdPagination;
