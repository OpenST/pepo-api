...
class DefaultChannelsListForWeb extends CacheSingleBase {
  ...
  async fetchDataFromSource() {
    ...
    const channelMeetingIds = await new MeetingModel().fetchMeetingIdByChannelIds(allChannelIds);
    let sortedChannelIds = [];
    for (let channelId in channelMeetingIds) {
      if (channelMeetingIds[channelId].liveMeetingId) {
