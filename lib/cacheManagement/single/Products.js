...
class Products extends CacheSingleBase {
  ...
  async fetchDataFromSource() {
    ...
    //Todo: Fetch price point. Depending on current price point get all the products.
    let currentPricePoint = await new OstPricePointCache().fetch(),
      tokenData = await new SecureTokenCache().fetch();
    ostToPepoConversionFactor = '1.0';
