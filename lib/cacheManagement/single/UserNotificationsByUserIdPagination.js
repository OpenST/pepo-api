...
class UserNotificationsByUserIdPagination extends CacheSingleBase {
   ...
   * @param {string} params.lastActionTimestamp
   *
   * @sets oThis.userId, oThis.limit, oThis.lastActionTimestamp
   *
   * @private
   */
  _initParams(params) {
    ...
    oThis.lastActionTimestamp = params.lastActionTimestamp;
  }
  ...
  _pageCacheKeySuffix() {
    ...
    return oThis.lastActionTimestamp;
  }
