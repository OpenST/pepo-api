...
class PersonalizedFeedByUserId {
  ...
  _setCacheExpiry() {
    ...
    oThis.cacheExpiry = cacheManagementConst.maxExpiryTimeInterval;
  ...
  async setCacheData(dataToSet) {
    ...
    console.log(`PERSONALIZED FEED:${oThis.userId} setCacheData=============================`, dataToSet);
  ...
  async fetch() {
    ...
    console.log(`PERSONALIZED FEED:${oThis.userId} fetchFromCache=============================`, data);
