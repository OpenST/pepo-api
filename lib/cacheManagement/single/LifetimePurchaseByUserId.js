...
class LifetimePurchaseByUserId extends CacheManagementBase {
  ...
  async fetchDataFromSource() {
    ...
    let fetchByUserIdRsp = await new FiatPaymentsModel().fetchTotalPurchaseAmountFor(oThis.userId);
    if (fetchByUserIdRsp.isFailure()) return Promise.reject(fetchByUserIdRsp);
