 ...
 *
 * @class ReplyDetailsByParentVideoPagination
 */
class ReplyDetailsByParentVideoPagination extends CacheSingleBase {
  /**
  ...
  async fetchDataFromSource() {
    ...
    const fetchRepliesRsp = await new ReplyDetailsModel().fetchByVideoId({
      videoId: oThis.videoId,
      limit: oThis.limit,
      paginationTimestamp: oThis.paginationTimestamp
    });

    return responseHelper.successWithData({ replyDetailIds: fetchRepliesRsp.replyIds });
  }
}

module.exports = ReplyDetailsByParentVideoPagination;
