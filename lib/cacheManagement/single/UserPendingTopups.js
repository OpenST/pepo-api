...
class UserPendingTopups extends CacheSingleBase {
  ...
  async fetchDataFromSource() {
    const oThis = this,
      pendingStatuses = [
        fiatPaymentConstants.invertedStatuses[fiatPaymentConstants.pendingStatus],
        fiatPaymentConstants.invertedStatuses[fiatPaymentConstants.paymentConfirmedStatus]
      ];
