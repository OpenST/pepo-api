...
class CacheManagementBase {
  ...
  _sanitizeCacheKeys() {
    ...
    oThis.cacheKey = escape(oThis.cacheKey);
  }
  ...
  async _setPaginationCacheKey() {
    ...
    oThis.cacheKey = escape(oThis.baseCacheKey + '_' + versionDetail.v + '_' + oThis._pageCacheKeySuffix());
  }
  ...
  async clear() {
    ...
    if (oThis._isPaginatedCache()) {
      let key = oThis._versionCacheKey;
