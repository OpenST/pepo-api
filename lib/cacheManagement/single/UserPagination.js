 ...
 * @class UserDetails
 */
class UserDetails extends CacheSingleBase {
  /**
  ...
  async fetchDataFromSource() {
    ...
    for (let i = 0; i < userIds.length; i++) {
      ...
      userDetail[userId] = userIdToTokenUserDetailsMap[userId];
      userDetail[userId]['userName'] = userIdToUserDetailsMap[userId].userName;
      userDetail[userId]['firstName'] = userIdToUserDetailsMap[userId].firstName;
      userDetail[userId]['lastName'] = userIdToUserDetailsMap[userId].lastName;

      finalResponse.push(userDetail);
    }
