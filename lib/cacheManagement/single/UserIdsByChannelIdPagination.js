 ...
 *
 * @class UserIdsByChannelIdPagination
 */
class UserIdsByChannelIdPagination extends CacheSingleBase {
  /**
   ...
   *
   * @sets oThis.channelId, oThis.limit, oThis.paginationTimestamp
   *
   * @private
   */
  _initParams(params) {
...
module.exports = UserIdsByChannelIdPagination;
