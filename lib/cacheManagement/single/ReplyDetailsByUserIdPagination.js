...
/**
 * Class to get reply details by user id.
 *
 * @class ReplyDetailsByUserIdPagination
 */
class ReplyDetailsByUserIdPagination extends CacheSingleBase {
  /**
  ...
  setPaginatedBaseCacheKey() {
    ...
    oThis.baseCacheKey = oThis._cacheKeyPrefix() + `_rd_uid_${oThis.userId}`;
  }
  ...
  async fetchDataFromSource() {
    ...
    const fetchUsersRsp = await new ReplyDetailsModel().fetchByCreatorUserId({
...
module.exports = ReplyDetailsByUserIdPagination;
