...
class SecureTokenUserByUserId extends CacheManagementBase {
  ...
  async fetchDataFromSource() {
    ...
    console.log('fetchSecureByUserIdRsp---', fetchSecureByUserIdRsp);
    ...
    if (fetchSecureByUserIdRsp.id) {
      ...
      console.log('encryptRsp-----', encryptRsp);

      if (encryptRsp.isSuccess()) {
        fetchSecureByUserIdRsp.encryptionSalt = encryptRsp.data.encryptedData;
