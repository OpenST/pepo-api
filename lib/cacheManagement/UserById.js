 ...
 *
 * @module lib/cacheManagement/shared/UserById
 */
const rootPrefix = '../..',
 ...
 * @class UserById
 */
class UserById extends CacheManagementBase {
  /**
   * Constructor to user from cache using id.
   *
   * @param {object} params
  ...
  setCacheKey() {
    ...
    oThis.cacheKey = oThis._cacheKeyPrefix() + `_user_by_uid_${oThis.id}`;
  ...
  async fetchDataFromSource() {
    ...
    let userObj = await new UserModel().fetchById(oThis.id);
