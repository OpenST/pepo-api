const rootPrefix = '../../..',
  ...
  UserContributedByModel = require(rootPrefix + '/app/models/mysql/UserContributedBy'),
  responseHelper = require(rootPrefix + '/lib/formatter/response'),
  cacheManagementConst = require(rootPrefix + '/lib/globalConstant/cacheManagement');

/**
 * Class to get UserContributedBy from cache using ContributedByUserId and UserIds.
 *
 * @class UserContributedByUserIdsAndContributedByUserId
 */
class UserContributedByUserIdsAndContributedByUserId extends CacheMultiBase {
  /**
  ...
  _setCacheKeys() {
    ...
    for (let i = 0; i < oThis.userIds.length; i++) {
      oThis.cacheKeys[
        oThis._cacheKeyPrefix() + '_cmm_ucb_cbuid_' + oThis.contributedByUserId + '_uids_' + oThis.userIds[i]
      ] =
        oThis.userIds[i];
    }
  }
  ...
  async fetchDataFromSource(cacheMissIds) {
    ...
    let contributedByUserObjs = await new UserContributedByModel().fetchByUserIdsAndcontributedByUserId(
      cacheMissIds,
...
module.exports = UserContributedByUserIdsAndContributedByUserId;
