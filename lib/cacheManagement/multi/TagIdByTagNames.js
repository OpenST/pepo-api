...
class TagIdByTagNamesIds extends CacheMultiBase {
   ...
   *
   * @param params
   * @param {Array} params.tagNames: tagNames
   *
   */
  constructor(params) {
    super(params);
  ...
  _initParams(params) {
    ...
    oThis.tagNames = params.tagNames;
  }
  ...
  _setCacheKeys() {
    ...
    for (let i = 0; i < oThis.tagNames.length; i++) {
      oThis.cacheKeys[oThis._cacheKeyPrefix() + '_cmm_tibtn_' + oThis.tagNames[i]] = oThis.tagNames[i];
    }
  }
