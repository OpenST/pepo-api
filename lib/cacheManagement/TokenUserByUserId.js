...
class TokenUserByUserId extends CacheManagementBase {
  ...
  _setBaseCacheKey() {
    ...
    oThis.baseCacheKey = oThis._cacheKeyPrefix() + '_token_user_by_uid_' + oThis.tokenId.toString();
    console.log('oThis.baseCacheKey-----', oThis.baseCacheKey);
  }
  ...
  async fetchDataFromSource() {
    ...
    for (let i = 0; i < userIds.length; i++) {
      ...
      finalResponse[userId]['userName'] = userIdToUserDetailsMap[userId];
    }
