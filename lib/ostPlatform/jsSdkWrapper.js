...
class JsSdkWrapper {
  ...
  async registerDevice(params) {
    ...
    const registerDeviceServiceResponse = await oThis.deviceService.create(params).catch(function(r) {
      return r;
    });
  ...
  async updateWebhooks(params) {
    ...
    const webhooksServiceResponse = await oThis.webhooksService.update(params);
