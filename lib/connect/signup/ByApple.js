...
class SignupByApple extends SignupBase {
  ...
  _getSocialUserName() {
    ...
    return oThis.appleUserEntity.userName;
  }
  ...
  _getSocialAccountName() {
    ...
    return oThis.appleUserEntity.formattedName;
  }
  ...
  async _createUpdateAppleUser() {
    ...
    let insertData = {
      ...
      name: oThis.appleUserEntity.formattedName,
      email: appleEmail
    };
  ...
  async _createAppleUserExtended() {
    ...
    let insertData = {
      apple_user_id: oThis.githubUserObj.id,
      access_token: encryptedAccessToken,
      refresh_token: oThis.appleOAuthDetails.refreshToken
    };
