...
class LoginConnectByGoogle extends LoginConnectBase {
  ...
  async _insertGoogleUserExtended() {
    ...
    let encryptedRefreshToken = null,
      encryptedAccessToken = oThis._getLCEncryptedToken(oThis.accessToken);

    if (oThis.refreshToken) {
      encryptedRefreshToken = oThis._getLCEncryptedToken(oThis.refreshToken);
    }
  ...
  async _updateGoogleUserExtended() {
    ...
    if (oThis.accessToken) {
      params.access_token = oThis._getLCEncryptedToken(oThis.accessToken);
    }

    if (oThis.refreshToken) {
      params.refresh_token = oThis._getLCEncryptedToken(oThis.refreshToken);
    }
