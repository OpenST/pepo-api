...
class Factory {
  ...
  getInstance(messageParams) {
    ...
    switch (messageParams.message.kind) {
      ...
      case notificationJobConstants.replyNotificationsKind: {
        return new oThis._replyNotificationsEvent(messageParams.message.payload);
      }
  ...
  get _replyNotificationsEvent() {
    return require(rootPrefix + '/lib/userNotificationPublisher/ReplyNotifications');
  }
