...
class Factory {
  ...
  getInstance(messageParams) {
    ...
    switch (messageParams.message.kind) {
      ...
      case notificationJobConstants.creditPepocornSuccesssKind: {
        return new oThis._creditPepocornSuccesssEvent(messageParams.message.payload);
      }
      default: {
  ...
  get _creditPepocornSuccesssEvent() {
    return require(rootPrefix + '/lib/userNotificationPublisher/CreditPepocornSuccesss');
  }
}
