...
class Factory {
  ...
  getInstance(messageParams) {
    ...
    switch (messageParams.message.kind) {
      ...
      case notificationJobConstants.replyThreadNotificationKind: {
        return new oThis._replyThreadNotification(messageParams.message.payload);
      }
  ...
  get _replyThreadNotification() {
    return require(rootPrefix + '/lib/userNotificationPublisher/ReplyThreadNotification');
  }
