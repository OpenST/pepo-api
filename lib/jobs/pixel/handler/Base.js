...
class Base {
  /**
   * Constructor for pixel job handler base.
   *
   * @param {object} params
   * @param {string} params.entityType
   * @param {string} params.entityAction
   *
   * @constructor
   */
  constructor(params) {
    ...
    oThis.entityAction = params.entityAction;
  }
  ...
  async perform() {
    ...
    const pixelIdentifier = pixelConstants.getPixelIdentifierKey(oThis.entityType, oThis.entityAction);
