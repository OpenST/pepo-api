...
class SlackApproveNewCreatorJobProcessor {
  ...
  _generateMessage() {
    ...
    const isApprovedCreator = UserModelKlass.isUserApprovedCreator(oThis.userData);
    //check muted status as well???

    if (isApprovedCreator) {
      //send unmute cta
      blocks.push(slackConstants.addUnmuteBlockSection(oThis.userId, isDoubleOptInDone));
    } else {
