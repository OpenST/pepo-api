...
class AfterSignUpJob {
  ...
  constructor(params) {
    ...
    oThis.pixelParams = {
      ...
      e_entity: pixelConstants.registerUserEntityType,
      e_action: pixelConstants.registerUserEntityAction,
      p_type: pixelConstants.registerUserPageType
    };
  }
  ...
  async _sendPixel() {
    ...
    await pixelJob.enqueue(pixelJobConstants.registerUserJob, oThis.pixelParams);
  }
}
