...
class UserData {
  ...
  processCsvDataForVideos() {
    ...
    for (let index = 0; index < parsedDataArray.length; index++) {
      ...
      oThis.deviceIdToVideoDetailsMap[parsedDataRow.device_id] = oThis.deviceIdToVideoDetailsMap[parsedDataRow.device_id] || {
  ...
  processCsvDataForReplies() {
    ...
    for (let index = 0; index < parsedDataArray.length; index++) {
      ...
      oThis.deviceIdToReplyDetailsMap[parsedDataRow.device_id] = oThis.deviceIdToReplyDetailsMap[parsedDataRow.device_id] || {
    ...
    for (const userId in userIdToDeviceIdsArray) {
      ...
      for (let index = 0; index < deviceIds.length; index++) {
        ...
        if (CommonValidators.validateNonEmptyObject(oThis.deviceIdToVideoDetailsMap[deviceId])) {
          ...
          if (oThis.deviceIdToVideoDetailsMap[deviceId].latestTimestamp > latestTimestamp) {
            latestTimestamp = oThis.deviceIdToVideoDetailsMap[deviceId].latestTimestamp;
          }
        }
        ...
        if (CommonValidators.validateNonEmptyObject(oThis.deviceIdToReplyDetailsMap[deviceId])) {
          ...
          if (oThis.deviceIdToReplyDetailsMap[deviceId].latestTimestamp > latestTimestamp) {
            latestTimestamp = oThis.deviceIdToReplyDetailsMap[deviceId].latestTimestamp;
          }
        }
      }
