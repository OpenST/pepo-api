...
class Factory {
  ...
  getInstance(messageParams) {
    ...
    switch (messageParams.message.kind) {
      ...
      case bgJobConstants.slackChannelMonitoringJobTopic: {
        return new oThis._slackChannelMonitoringJobProcessor(messageParams.message.payload);
      }
  ...
  get _slackChannelMonitoringJobProcessor() {
    return require(rootPrefix + '/lib/jobs/bg/SlackChannelMonitoringJobProcessor');
  }
