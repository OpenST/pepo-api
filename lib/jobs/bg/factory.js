...
class Factory {
  ...
  getInstance(messageParams) {
    ...
    switch (messageParams.message.kind) {
      ...
      case bgJobConstants.zoomWebhookJobTopic: {
        return new oThis._zoomWebhookJobTopic(messageParams.message.payload);
      }
      case bgJobConstants.endZoomMeetingJobTopic: {
        return new oThis._endZoomMeetingJobTopic(messageParams.message.payload);
      }
      ...
      case bgJobConstants.slackLiveEventMonitoringJobTopic: {
        return new oThis._slackLiveEventMonitoringJobProcessor(messageParams.message.payload);
      }
      case bgJobConstants.slackCommunityMonitoringJobTopic: {
        return new oThis._slackCommunityMonitoringJobProcessor(messageParams.message.payload);
      }
  ...
  get _zoomWebhookJobTopic() {
    return require(rootPrefix + '/app/services/zoomEvents/Process');
  }

  get _endZoomMeetingJobTopic() {
    return require(rootPrefix + '/lib/jobs/bg/EndZoomMeetingJob');
  }
  ...
  get _slackLiveEventMonitoringJobProcessor() {
    return require(rootPrefix + '/lib/jobs/bg/SlackLiveEventMonitoringJobProcessor');
  }

  get _slackCommunityMonitoringJobProcessor() {
    return require(rootPrefix + '/lib/jobs/bg/SlackCommunityMonitoringJobProcessor');
  }
