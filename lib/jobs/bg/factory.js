...
class Factory {
  ...
  getInstance(messageParams) {
    ...
    switch (messageParams.message.kind) {
      ...
      case bgJobConstants.updateCommunityDataUsageTopic: {
        return new oThis._updateCommunityDataUsage(messageParams.message.payload);
      }
  ...
  get _updateCommunityDataUsage() {
    return require(rootPrefix + '/lib/jobs/bg/updateUsageData/CommunityData');
  }
