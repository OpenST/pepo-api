...
class Factory {
  ...
  getInstance(messageParams) {
    ...
    switch (messageParams.message.kind) {
      ...
      case bgJobConstants.slackApproveNewCreatorJobTopic: {
        return new oThis._slackApproveNewCreatorJobProcessor(messageParams.message.payload);
      }
      case bgJobConstants.slackContentMonitoringJobTopic: {
        return new oThis._slackContentMonitoringJobProcessor(messageParams.message.payload);
      }
  ...
  get _slackApproveNewCreatorJobProcessor() {
    return require(rootPrefix + '/lib/jobs/bg/SlackApproveNewCreatorJobProcessor');
  }

  get _slackContentMonitoringJobProcessor() {
    return require(rootPrefix + '/lib/jobs/bg/SlackContentMonitoringJobProcessor');
  }
