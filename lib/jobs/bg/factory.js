...
class Factory {
  ...
  getInstance(messageParams) {
    ...
    switch (messageParams.message.kind) {
      ...
      case bgJobConstants.contentMonitoringJobTopic: {
        return new oThis._contentMonitoringJobProcessor(messageParams.message.payload);
      }
  ...
  get _contentMonitoringJobProcessor() {
