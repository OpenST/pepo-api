...
class Factory {
  ...
  getInstance(messageParams) {
    ...
    switch (messageParams.message.kind) {
      case pepoMobileEventConstants.feedVideoViewKind: {
        return new oThis._feedVideoViewEvent(messageParams);
      }
      default: {
  ...
  get _feedVideoViewEvent() {
    return require(rootPrefix + '/lib/jobs/pepoMobile/FeedVideoView');
  }
}
