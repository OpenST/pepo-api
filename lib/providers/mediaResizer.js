...
class MediaResizer {
  ...
  resizeImage(requestData) {
    ...
    return oThis._invokeLambdaRequest(coreConstants.PR_IMAGE_RESIZE_FUNCTION, requestData);
  }
  ...
  compressVideo(requestData) {
    ...
    return oThis._invokeLambdaRequest(coreConstants.PR_VIDEO_COMPRESS_FUNCTION, requestData);
  }
  ...
  mergeVideoSegments(requestData) {
    ...
    return oThis._invokeLambdaRequest(coreConstants.PR_VIDEO_MERGE_FUNCTION, requestData);
  }
