...
class ReplyReceiverWithoutAmount extends UserNotificationPublisherBase {
   ...
   * @param {number} params.videoOwnerUserId
  ...
  constructor(params) {
    ...
    oThis.videoOwnerUserId = params.videoOwnerUserId;
  ...
  async _validateAndSanitizeParams() {
    ...
    if (
      ...
      !CommonValidators.validateNonZeroInteger(oThis.videoOwnerUserId) ||
      ...
      return Promise.reject(
        responseHelper.error({
          ...
          debug_options: {
            ...
            videoOwnerUserId: oThis.videoOwnerUserId
          }
        })
      );
    }
  ...
  async _setNotificationCentrePayload() {
    ...
    oThis.payload = {
      ...
      actorCount: 1,
      subjectUserId: oThis.videoOwnerUserId,
      payload: {
        replyDetailId: oThis.replyDetailId,
        videoId: oThis.videoId
      }
  ...
  async _publishForUserIds() {
    ...
    if (oThis.mentionedUserIds.includes(oThis.videoOwnerUserId)) {
      return;
    }

    oThis.publishUserIds = [oThis.videoOwnerUserId];
