...
class ReplyOnYourVideoWithoutAmount extends UserNotificationPublisherBase {
  /**
  ...
  async _validateAndSanitizeParams() {
    ...
    logger.log('End:: Validate for ReplyOnYourVideoWithoutAmount');
  }
  ...
  async _setNotificationCentrePayload() {
    const oThis = this;
    logger.log('Start:: _setNotificationCentrePayload for ReplyOnYourVideoWithoutAmount');
    ...
    logger.log('End:: _setNotificationCentrePayload for ReplyOnYourVideoWithoutAmount');
  }
  ...
  _userNotificationKind() {
    return userNotificationConstants.replyOnYourVideoWithoutAmountKind;
  }
  ...
  _notificationHookKind() {
    return notificationHookConstants.replyOnYourVideoWithoutAmountKind;
  }
}

module.exports = ReplyOnYourVideoWithoutAmount;
