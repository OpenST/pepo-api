...
/**
 * Constructor for Topup done.
 *
 * @class TopupDonePublisher
 */
class TopupDonePublisher extends UserNotificationPublisherBase {
  /**
  ...
  async _validateAndSanitizeParams() {
    ...
    logger.log('Start:: Validate for TopupDonePublisher', tx);
    ...
    logger.log('End:: Validate for TopupDonePublisher');
  }
   ...
   */
  _jobTopic() {
    return notificationJobConstants.topupDone;
  }
  ...
  _setNotificationCentrePayload() {
    ...
    logger.log('Start:: _setNotificationCentrePayload for TopupDonePublisher');
    ...
    logger.log('End:: _setNotificationCentrePayload for TopupDonePublisher');
  }
  ...
  _userNotificationKind() {
    return userNotificationConstants.topupDoneKind;
  }
}

module.exports = TopupDonePublisher;
