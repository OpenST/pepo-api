 ...
 * @class TopupDone
 */
class TopupDone extends UserNotificationPublisherBase {
  /**
  ...
  async _validateAndSanitizeParams() {
    ...
    logger.log('Start:: Validate for TopupDone', tx);

    if (!CommonValidators.validateNonEmptyObject(tx)) {
      hasError = true;
    }

    // TODO: Anagha Temp commit.
    ...
    logger.log('End:: Validate for TopupDone');
  }
  ...
  _setNotificationCentrePayload() {
    ...
    logger.log('Start:: _setNotificationCentrePayload for TopupDone');
    ...
    logger.log('End:: _setNotificationCentrePayload for TopupDone');
  }
  ...
  _notificationHookKind() {
    return notificationHookConstants.topupDoneKind;
  }
}

module.exports = TopupDone;
