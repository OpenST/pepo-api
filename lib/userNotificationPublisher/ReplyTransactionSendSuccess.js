...
/**
 * Constructor for reply user transaction send success publishing.
 *
 * @class ReplyTransactionSendSuccess
 */
class ReplyTransactionSendSuccess extends UserNotificationPublisherBase {
  /**
   * Constructor for reply user transaction send success publishing.
   *
   * @param {object} params
  ...
  async _validateAndSanitizeParams() {
    ...
    logger.log('Start:: Validate for ReplyTransactionSendSuccess');
    ...
    if (hasError) {
      return Promise.reject(
        responseHelper.error({
          internal_error_identifier: 'l_unp_rtss_vas_1',
    ...
    logger.log('End:: Validate for ReplyTransactionSendSuccess');
  }
  ...
  _setNotificationCentrePayload() {
    const oThis = this;
    logger.log('Start:: _setNotificationCentrePayload for ReplyTransactionSendSuccess');
    ...
    logger.log('End:: _setNotificationCentrePayload for ReplyTransactionSendSuccess');
  }
  ...
  _userNotificationKind() {
    return userNotificationConstants.replyTxSendSuccessKind;
  }
}

module.exports = ReplyTransactionSendSuccess;
