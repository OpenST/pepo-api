const rootPrefix = '../..',
  ...
  AggregatedNotificationModel = require(rootPrefix + '/app/models/mysql/big/AggregatedNotification'),
...
class UserNotificationPublisherBase {
  ...
  constructor() {
    ...
    oThis.pushNotificationCreated = false;
  }
  ...
  async _createEntriesForUserDeviceIdsInNotificationHookModel() {
    ...
    oThis.pushNotificationCreated = true;
  }
  ...
  async _insertIntoAggregatedNotificationsTable() {
    ...
    const userId = oThis.transaction.toUserId;
    ...
    const amountInEth = basicHelper.convertWeiToNormal(oThis.transaction.amount);
