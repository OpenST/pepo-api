...
class EditReplyDescription extends EditDescriptionBase {
   ...
   *
   * @sets oThis.replyDetail, oThis.creatorUserId, oThis.existingTextId
   *
  ...
  async _fetchDetails() {
    ...
    oThis.existingTextId = oThis.replyDetail.descriptionId || null;
  ...
  async _flushCache() {
    ...
    const promisesArray = [
      ReplyDetailsModel.flushCache({ replyDetailId: oThis.replyDetailId, videoId: oThis.videoId })
    ];
