...
class GiphySdkWrapper {
    ...
    if (null != responseData) {
      responseData.forEach((gifObj) => {
        formattedResponse.push({
          kind: gifObj.type,
          id: gifObj.id,
          downsized: gifObj.images.downsized,
          fixed_height: gifObj.images.fixed_height,
          fixed_height_downsampled: gifObj.images.fixed_height_downsampled,
          ...
          preview_gif: gifObj.images.preview_gif,
          preview_webp: gifObj.images.preview_webp || null,
          tags: gifObj.tags || []
        });
      });
    }
  ...
  /**
   * Page size for giphy request from Pepo App.
   *
   * @returns {number}
   */
  get pepoDefaultPageSizeForGiphy() {
    return 18;
  }
