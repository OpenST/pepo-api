...
class EmailServiceApiCallHook {
  ...
  get redemptionReceiverEntityKind() {
    return 'REDEMPTION_RECEIVER';
  }
  ...
  get receiverEntityKinds() {
    ...
    return {
      ...
      '4': oThis.redemptionReceiverEntityKind,
      '5': oThis.hookParamsInternalEmailEntityKind
    };
  }
  ...
  get reportIssueForVideoTemplateName() {
    return 'report_issue_for_video';
  }
  ...
  get supportedTemplatesMap() {
    ...
    return {
      ...
      [oThis.reportIssueForVideoTemplateName]: 1
    };
  }
