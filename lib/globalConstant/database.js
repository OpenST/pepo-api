...
class Database {
  ...
  get socialConnectDbName() {
    return dbNamePrefix + '_social_connect' + dbNameSuffix;
  }

  get meetingDbName() {
    return dbNamePrefix + '_meeting' + dbNameSuffix;
  }
  ...
  get channelDbName() {
    return dbNamePrefix + '_channel' + dbNameSuffix;
  }
  // MySQL databases end.
}
