...
class BgJob {
  ...
  get zoomWebhookJobTopic() {
    return 'bg.p1.zoomWebhookJob';
  }

  get endZoomMeetingJobTopic() {
    return 'bg.p1.endZoomMeeting';
  }
  ...
  get slackLiveEventMonitoringJobTopic() {
    return 'bg.p1.slackLiveEventMonitoringJobTopic';
  }

  get slackCommunityMonitoringJobTopic() {
    return 'bg.p1.slackCommunityMonitoringJobTopic';
  }
  ...
  get updateChannelDataUsageTopic() {
    return 'bg.p1.updateChannelDataUsageJob';
  }
