...
class BgJob {
  ...
  get slackApproveNewCreatorJobTopic() {
    return 'bg.p1.slackApproveNewCreatorJobTopic';
  }

  get slackContentMonitoringJobTopic() {
    return 'bg.p1.slackContentMonitoringJobTopic';
  }
