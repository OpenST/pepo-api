...
class TransactionConstants {
  ...
  get extraData() {
    return {
      airdropKind: oThis.airdropKind,
      redemptionKind: oThis.redemptionKind,
      userTransactionKind: oThis.userTransactionKind,
      topUpKind: oThis.topUpKind,
      replyOnVideoTransactionKind: oThis.replyOnVideoTransactionKind,
      userTransactionOnReplyKind: oThis.userTransactionOnReplyKind
    };
  }
