...
class AdminActivityLogs {
  ...
  get createEditCommunityEntity() {
    return 'createEditCommunityEntity';
  }
  ...
  get blockUserInChannel() {
    return 'blockUserInChannel';
  }

  get unapprovedAsCreator() {
    return 'unapprovedAsCreator';
  }
  ...
  get actions() {
    ...
    return {
      ...
      '14': oThis.blockUserInChannel,
      '15': oThis.unapprovedAsCreator,
      '16': oThis.createEditCommunityEntity
    };
  }
