...
class UserNotificationConstants {
  ...
  get userMentionInChannelKind() {
    return 'USER_MENTION_CHANNEL';
  }
  ...
  get videoAddSupportersAndChannelMembersKind() {
    return 'VIDEO_ADD_SUPPORTERS_CHANNEL_MEMBERS';
  }
  ...
  get channelGoLiveNotificationKind() {
    return 'CHANNEL_GO_LIVE';
  }
  ...
  get kinds() {
    ...
    return {
      ...
      '27': oThis.videoAddInChannelKind,
      '28': oThis.userMentionInChannelKind,
      '29': oThis.videoAddSupportersAndChannelMembersKind,
      '30': oThis.channelGoLiveNotificationKind
    };
  }
