...
class ErrorLogs {
  ...
  get walletSdkInternalAppName() {
    return 'wallet-sdk-internal';
  }

  get walletSdkPlatformApiAppName() {
  ...
  get appNames() {
    const oThis = this;
    return [oThis.walletSdkInternalAppName, oThis.walletSdkPlatformApiAppName, oThis.pepoApiAppName];
  }
