...
class AuthLoginCookie {
  ...
  async _setParts() {
    ...
    } else if (oThis.cookieVersion != oThis.apiSource) {
  ...
  async _validateToken() {
    ...
    let token = new UserModel().getCookieValueFor(oThis.current_user, oThis.decryptedEncryptionSalt, {
