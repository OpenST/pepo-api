...
class RemoveChannelTagVideo {
  ...
  async perform() {
    ...
    await oThis._updateChannelStats(); // Step 4.
  }

  /**
   * Create prerequisite data.
   *
   * @sets oThis.channelIds, oThis.channelIdToTagIdsMap, oThis.toBeUpdatedChannelVideosMap
  ...
  _createPrerequisiteData() {
    ...
    logger.debug('==oThis.toBeUpdatedChannelVideosMap====', oThis.toBeUpdatedChannelVideosMap);
  }
  ...
  _getChannelVideosToMarkInactive() {
     ...
     */
    console.log('==oThis.toBeUpdatedChannelVideosMap====111=====', oThis.toBeUpdatedChannelVideosMap);
    console.log('==oThis.activeChannelTagVideos====222=====', oThis.activeChannelTagVideos);
