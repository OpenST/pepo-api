...
class Account extends Base {
  ...
  constructor() {
    ...
    oThis.resource = 'https://api.twitter.com/account';
  }
  ...
  async verifyCredentials(params) {
    ...
    let completeUrl = oThis.resource + '/verify_credentials';
    ...
    let userEntity = new UserTwitterEntityClass(parsedResponse.data[0]);
