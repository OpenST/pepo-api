 ...
 * Twitter Users
 *
 * @module lib/twitter/oauth1.0/Users
 */
const rootPrefix = '../../..',
...
class Users extends Base {
  ...
  async lookup(params) {
    ...
    let response = await oThis._fireRequest(authorizationHeaderParams, completeUrl, requestParams);
    ...
    for (let i = 0; i < parsedResponse.data.length; i++) {
      let userEntity = new UserTwitterEntityClass(parsedResponse.data[i]);
      finalResp[i] = userEntity;
    }
