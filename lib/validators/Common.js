...
class CommonValidator {
  ...
  /**
   * Validate channel tags array.
   *
   * @param {array<string>} array
   *
   * @returns {boolean}
   */
  static validateChannelTagsArray(array) {
    if (Array.isArray(array)) {
      ...
      for (let index = 0; index < array.length; index++) {
        ...
        if (
          CommonValidator.isVarNullOrUndefined(variable) ||
          !CommonValidator.validateNonEmptyString(variable) ||
          variable.length > 60
        ) {
          return false;
        }
  ...
  /**
   * Validate stringified channel tags array.
   *
   * @param {string} string
   *
   * @returns {boolean}
   */
  static validateChannelTagsCommaDelimitedString(string) {
    if (CommonValidator.validateCommaDelimitedStrings(string)) {
      const channelTagsArray = string.split(',');

      return CommonValidator.validateChannelTagsArray(channelTagsArray);
    }
