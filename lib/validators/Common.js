...
class CommonValidator {
  ...
  static validateChannelTitle(string) {
    return CommonValidator.validateString(string) && string.length <= 30;
  }
  ...
  static validateChannelTagline(string) {
    return CommonValidator.validateString(string) && string.length <= 128;
  }
  ...
  static validateChannelDescription(string) {
    return CommonValidator.validateString(string) && string.length <= 512;
  }
