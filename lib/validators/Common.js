...
class CommonValidator {
  ...
  static validateOstTransactionMetaGiphy(variable) {
    ...
    if (
      ...
      CommonValidator.isVarNullOrUndefined(previewWebp) ||
      CommonValidator.isVarNullOrUndefined(tags)
    ) {
      return false;
    }
    ...
    if (
      ...
      !CommonValidator.validateOstTransactionMetaGiphySizeData(previewWebp) ||
      !CommonValidator.validateArray(tags)
    ) {
      return false;
    }
