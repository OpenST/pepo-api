...
const cronSignature = {
  ...
  [cronProcessConstants.webhookJobPreProcessor]: {
    mandatory: [
      {
        parameter: 'topics',
        validatorMethods: ['validateArray']
  ...
  [cronProcessConstants.pixelJobProcessor]: {
    mandatory: [
      {
        parameter: 'topics',
        validatorMethods: ['validateArray']
  ...
  [cronProcessConstants.webhookProcessor]: {
    mandatory: [],
    optional: []
  },
  ...
  [cronProcessConstants.populatePopularityCriteria]: {
    mandatory: [],
    optional: []
  }
};
