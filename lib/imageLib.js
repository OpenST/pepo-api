...
class ImageLib {
  ...
  _shortenExternalUrl(imageUrl) {
    ...
    if (shortUrl.match(imageConstants.twitterImagePrefix)) {
      ...
      shortUrl = imageUrl.replace(imageConstants.githubImageUrlPrefix[0], imageConstants.githubImageUrlPrefix[1]);
    } else if (shortUrl.match(imageConstants.googleImagePrefix)) {
      shortUrl = imageUrl.replace(imageConstants.googleImageUrlPrefix[0], imageConstants.googleImageUrlPrefix[1]);
    }
