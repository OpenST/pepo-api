...
class SaveRecording {
  ...
  async _asyncPerform() {
    ...
    console.log(JSON.stringify(await oThis._validateZoomMeetingId()));
    console.log(JSON.stringify(await oThis._fetchRecordingURL()));
    console.log(JSON.stringify(await oThis._downloadFiles()));
    console.log(JSON.stringify(await oThis._uploadToS3()));
  ...
  async _download(recordingFile) {
    ...
    const writeToFilePromise = new Promise(async function(onResolve, onReject) {
